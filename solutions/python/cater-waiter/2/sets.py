...
def check_drinks(drink_name, drink_ingredients):
    ...
    if ingredients.isdisjoint(ALCOHOLS):
        halal = drink_name + " Mocktail"
    else:
        halal = drink_name + " Cocktail"
    return halal
...
def separate_appetizers(dishes, appetizers):
    ...
    remaining_dishes = dishes_set.difference(appetizers_set)
...
def singleton_ingredients(dishes, intersection):
    ...
    singletons = all_ingredients.difference(intersection)
